//tex from fmdl studio (2019-12), modified to be independant of unity classes (like the old fmdl.cs was).
//OFF using FmdlStudio.Scripts.MonoBehaviours;
//OFF using FmdlStudio.Scripts.Static;
using FcnpTool;
using System;
using System.Collections.Generic;
using System.IO;
//OFF using UnityEditor;
//OFF using UnityEngine;
